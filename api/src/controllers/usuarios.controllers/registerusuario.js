...
module.exports = async(req,res)=>{
    const{dni, password, apellido, nombre, cargo, escuela, modalidad, zona, email, telefono, permiso} = req.body;
    ...
    try{
        const [result] = await pool.query(`INSERT INTO usuarios(dni, password, apellido, nombre, cargo, escuela, modalidad, zona, email, telefono, permiso) VALUES(${dni}, '${password}', '${apellido}', '${nombre}', '${cargo}', '${escuela}', '${modalidad}', '${zona}', '${email}', '${telefono}', '${permiso}'); `);
